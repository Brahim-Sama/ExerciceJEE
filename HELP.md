...
* The following dependencies are not known to work with Spring Native: 'Rest Repositories, Spring Boot DevTools, Spring
...
```
$ docker run --rm -p 8080:8080 medical:0.0.1-SNAPSHOT
```
